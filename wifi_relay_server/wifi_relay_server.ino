...
// Relays
// --------------------------
void activateRelay1() {digitalWrite(RELAY_1, LOW);}
void activateRelay2() {digitalWrite(RELAY_2, LOW);}
void disableRelay1() {digitalWrite(RELAY_1, HIGH);}
void disableRelay2() {digitalWrite(RELAY_2, HIGH);}
String statusRelays() {
